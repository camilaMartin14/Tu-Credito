...
namespace TuCredito.Services.Implementations
{
    public class PrestamoService : IPrestamoService
    {
        ...
        public PrestamoService(IPrestamoRepository repo, IMapper mapper, IPrestatarioRepository prestatario)
        {
            _repo = repo;
        ...
        public async Task<bool> PostPrestamo(PrestamoDTO NvoPrestamo)
        {
            ...
            await _repo.PostPrestamo(NvoPrestamo);
            return true;           
        }
        public async Task<bool> SoftDelete(int id)
        {
            ...
            if (_repo.TienePagosPendientes(id).Result == true) throw new ArgumentException("No se pueden finalizar prestamos que aun tengan pagos pendientes"); 
                                             // no se si esta bien planteada la comparacion del resultado. ME HACE RUIDOO
            await _repo.SoftDelete(prestamo.IdEstado);
            return true;
        }
