...
public partial class TuCreditoContext : DbContext
{
    ...
    public virtual DbSet<Prestamista> Prestamista { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCuota).HasName("PK__Cuotas__9BE53C18A989118D");
        ...
        {
            entity.HasKey(e => e.IdEstado).HasName("PK__Estado_C__62EA894AFF07EE3C");

            entity.ToTable("Estado_Cuota");
        ...
        {
            entity.HasKey(e => e.IdEstado).HasName("PK__Estado_P__62EA894A5F248AFC");
        ...
        {
            entity.HasKey(e => e.IdGarante).HasName("PK__Garante__071AE8B6B1A90E6A");
        ...
        {
            entity.HasKey(e => e.IdMedioPago).HasName("PK__MediosDe__7AE6AD6DEDEA17B8");
        ...
        {
            entity.HasKey(e => e.IdPago).HasName("PK__Pagos__BD2295AD45E74A93");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Prestami__3213E83F9513B17E");
        ...
        {
            entity.HasKey(e => e.IdPrestamo).HasName("PK__Prestamo__A4876C13F971A5E1");
        ...
        {
            entity.HasKey(e => e.IdSistAmortizacion).HasName("PK__SistAmor__4E23826B319370AC");
